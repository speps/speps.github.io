...
}`;class Q{constructor(t,i){this.map={},this.id=t,this.spec=i;let s=Math.ceil(Math.sqrt(i.glyphs.length));this.width=s*i.width,this.height=s*i.height;for(let e=0;e<i.glyphs.length;e++){let r=e%s,n=Math.floor(e/s);this.map[i.glyphs[e]]=new a(r*i.width,n*i.height)}}}class P{constructor(t=0){this.index=t}}class S{constructor(t){this.fn=t}}class J{constructor(t,i){this.location=t,this.value=i}}class ${constructor(t){this.uniforms={},this.id=t}}class tt{constructor(t,i,s,e){this.index=t,this.size=i,this.stride=s,this.offset=e}}class et{constructor(t){this.attribs=[],this.num=0,this.id=t}}class it{constructor(t){this.fonts={},this.programs={},this.buffers={},this.gl=t;const i=new S(()=>o.currentTime);this.createProgram("background",L,H,{u_camera_position:new a(0,0),u_camera_scale:new a(1,1),u_time:i}),this.createProgram("cell",_,U,{u_resolution:new a(0,0),u_camera_position:new a(0,0),u_camera_scale:new a(1,1),u_position:new a(0,0),u_size:new a(1,1),u_time:i,u_direction:new a(0,-1),u_split:0,u_radius:0}),this.createProgram("particle",_,Y,{u_resolution:new a(0,0),u_camera_position:new a(0,0),u_camera_scale:new a(1,1),u_position:new a(0,0),u_size:new a(1,1),u_time:i,u_direction:new a(0,-1),u_glow:0,u_radius:0,u_color:new x(0,0,0,0)}),this.createProgram("collector",_,Z,{u_camera_position:new a(0,0),u_camera_scale:new a(1,1),u_position:new a(0,0),u_size:new a(1,1),u_color:new x(0,0,0,0)}),this.createProgram("debug_circle",_,X,{u_camera_position:new a(0,0),u_camera_scale:new a(1,1),u_position:new a(0,0),u_size:new a(1,1),u_thickness:0,u_color:new x(0,0,0,0)}),this.createProgram("font",q,K,{u_resolution:new a(1,1),u_camera_position:new a(0,0),u_camera_scale:new a(1,1),u_position:new a(0,0),u_size:new a(1,1),u_font:new P(0),u_char_pos:new a(0,0),u_char_size:new a(0,0)}),this.createBuffer("screen",[[2,16,0],[2,16,8]],[-1,-1,0,0,3,-1,2,0,-1,3,0,2]),this.createBuffer("quad",[[2,16,0],[2,16,8]],[-.5,-.5,0,0,.5,-.5,1,0,.5,.5,1,1,-.5,-.5,0,0,.5,.5,1,1,-.5,.5,0,1]),this.loadFont("debug",N)}createProgram(t,i,s,e){const r=new $(this.gl.createProgram());if(r.id===null)throw"createProgram";let n=(g,y)=>{const w=this.gl.createShader(g);if(w===null)throw"createShader";if(this.gl.shaderSource(w,y),this.gl.compileShader(w),!this.gl.getShaderParameter(w,this.gl.COMPILE_STATUS))throw`compileShader:${this.gl.getShaderInfoLog(w)}:${y}`;return w};const l=O+i.replace(`#version 300 es
precision highp float;
`,""),c=n(this.gl.VERTEX_SHADER,l),d=C+s.replace(`#version 300 es
precision highp float;
`,""),f=n(this.gl.FRAGMENT_SHADER,d);if(this.gl.attachShader(r.id,c),this.gl.attachShader(r.id,f),this.gl.linkProgram(r.id),!this.gl.getProgramParameter(r.id,this.gl.LINK_STATUS))throw`linkProgram:${this.gl.getProgramInfoLog(r.id)}`;for(let g in e){const y=this.gl.getUniformLocation(r.id,g);y===null&&console.warn(`getUniformLocation:${t}:${g}`),r.uniforms[g]=new J(y,e[g])}this.programs[t]=r}createBuffer(t,i,s){const e=new et(this.gl.createBuffer());if(e.id===null)throw"createBuffer";this.gl.bindBuffer(this.gl.ARRAY_BUFFER,e.id),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array(s),this.gl.STATIC_DRAW);let r=0;for(let n=0;n<i.length;n++){const l=i[n];r+=l[0],e.attribs.push(new tt(n,l[0],l[1],l[2]))}e.num=s.length/r,this.buffers[t]=e}loadFont(t,i){const s=new Q(this.gl.createTexture(),i);if(s.id===null)throw"createTexture";fetch(s.spec.data).then(e=>{e.blob().then(r=>{createImageBitmap(r).then(n=>{this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,s.id),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_MIN_FILTER,this.gl.LINEAR),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_MAG_FILTER,this.gl.LINEAR),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_S,this.gl.CLAMP_TO_EDGE),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_T,this.gl.CLAMP_TO_EDGE),this.gl.texImage2D(this.gl.TEXTURE_2D,0,this.gl.RGBA8,this.gl.RGBA,this.gl.UNSIGNED_BYTE,n),this.fonts[t]=s})})})}bindProgram(t){const i=this.programs[t];this.gl.useProgram(i.id);for(let s in i.uniforms){const e=i.uniforms[s];e.location!==null&&(typeof e.value=="number"&&this.gl.uniform1f(e.location,e.value),e.value instanceof a&&this.gl.uniform2f(e.location,e.value.x,e.value.y),e.value instanceof F&&this.gl.uniform3f(e.location,e.value.x,e.value.y,e.value.z),e.value instanceof x&&this.gl.uniform4f(e.location,e.value.x,e.value.y,e.value.z,e.value.w),e.value instanceof P&&this.gl.uniform1i(e.location,e.value.index),e.value instanceof S&&this.gl.uniform1f(e.location,e.value.fn()))}}bindBuffer(t){const i=this.buffers[t];this.gl.bindBuffer(this.gl.ARRAY_BUFFER,i.id);for(let s=0;s<i.attribs.length;s++){const e=i.attribs[s];this.gl.enableVertexAttribArray(s),this.gl.vertexAttribPointer(s,e.size,this.gl.FLOAT,!1,e.stride,e.offset)}}drawBuffer(t,i){this.bindProgram(i),this.bindBuffer(t),this.gl.drawArrays(this.gl.TRIANGLES,0,this.buffers[t].num)}blendOff(){this.gl.disable(this.gl.BLEND)}blendPremul(){this.gl.enable(this.gl.BLEND),this.gl.blendFunc(this.gl.ONE,this.gl.ONE_MINUS_SRC_ALPHA)}drawScreenText(t,i,s,e){const r=this.fonts[t];r!==void 0&&(this.programs.font.uniforms.u_resolution.value.set(o.currentViewWidth,o.currentViewHeight),this.programs.font.uniforms.u_camera_position.value.set(o.currentViewWidth*.5,o.currentViewHeight*.5),this.programs.font.uniforms.u_camera_scale.value.set(o.currentViewWidth*.5,o.currentViewHeight*.5),this.programs.font.uniforms.u_size.value.set(r.spec.width,r.spec.height),this.programs.font.uniforms.u_char_size.value.set(r.spec.width,r.spec.height),this.drawText(r,i,s,r.spec.width,r.spec.height,e))}drawWorldText(t,i,s,e,r){const n=this.fonts[t];if(n===void 0)return;this.programs.font.uniforms.u_resolution.value.set(o.currentViewWidth,o.currentViewHeight),this.programs.font.uniforms.u_camera_position.value.setFrom(i),this.programs.font.uniforms.u_camera_scale.value.set(o.currentWorldWidth*.5,o.currentWorldHeight*.5);const l=n.spec.width/o.currentScale,c=n.spec.height/o.currentScale;this.programs.font.uniforms.u_size.value.set(l,c),this.programs.font.uniforms.u_char_size.value.set(n.spec.width,n.spec.height),this.drawText(n,s,e,l,c,r)}drawText(t,i,s,e,r,n){this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,t.id);const l=i;i+=e*.5,s+=r*.5;for(let c of n){if(c==`
`){i=l+e*.5,s+=r;continue}if(c=="\0"){i+=e;continue}const d=c.codePointAt(0);if(d!==void 0){const f=t.map[d];f!==void 0&&(this.programs.font.uniforms.u_position.value.set(i,s),this.programs.font.uniforms.u_char_pos.value.setFrom(f),this.drawBuffer("quad","font"))}i+=e}}}class v{static halton(t,i){let s=0,e=1/i;for(;t>0;){let r=t%i;s+=r*e,t=(t-r)/i,e/=i}return s}static lerp(t,i,s){return t+(i-t)*s}static clamp(t,i,s){return t<i?i:t>s?s:t}static ease(t){return t=t-1,t*t*t*t}static rad(t){return t*Math.PI/180}}class E{constructor(){this.position=new a(0,0),this.direction=new a(0,-1),this.size=0,this.timerDivide=0,this.timerChain=0,this.timerDead=0,this.dead=!1,this.blinking=!1,this.blinkShow=!0,this.blinkTimer=0,this.radius=0,this.chainRadius=0,this.deadRadius=0,this.captured=[],this.updateValues()}updateValues(){this.radius=v.lerp(u.minRadius,u.maxRadius,this.size),this.chainRadius=v.lerp(0,this.radius+u.maxChainRadius,v.clamp(this.timerChain/u.chainDelay,0,1)),this.deadRadius=v.lerp(0,this.radius+u.maxDeadRadius,v.clamp(this.timerDead/u.deadDelay,0,1)),!this.dead&&this.size>=1&&this.die()}setInitialValues(){this.timerDivide=u.divideDelay,this.timerChain=u.chainDelay,this.size=.5,this.captured=[]}clearCaptured(){for(let t=0;t<this.captured.length;t++){let i=this.captured[t];i.captured=!1}this.captured=[]}canChain(){return this.timerChain<u.chainDelay}dying(){return this.dead&&this.timerDead<u.deadDelay}die(){this.dead=!0,this.timerChain=u.chainDelay,this.clearCaptured()}canDivide(){return!this.isDead()&&!this.dying()&&this.timerDivide>=u.divideDelay}isDividing(){return this.timerDivide<u.divideDelay}isDead(){return this.dead&&this.timerDead>=u.deadDelay}update(t,i){i||(this.dead?this.timerDead+=t:(this.size=v.clamp(this.size+u.sizeGrowth*t,0,1),this.position.add(this.direction.copy().scale(v.lerp(u.minVelocity,u.maxVelocity,v.ease(this.size))*t)),this.timerDivide+=t,this.timerChain+=t)),(1-this.size)/u.sizeGrowth<u.feedbackDeathDelay?(this.blinking||(this.blinking=!0),this.blinkTimer-=t,this.blinkTimer<0&&(this.blinkShow=!this.blinkShow,this.blinkTimer=u.feedbackDeathBlinkDelay)):this.blinkShow=!0,this.updateValues()}}class st{constructor(){this.position=new a}reset(){this.position.set(0,0)}cameraCoords(t){return new a((t.x-this.position.x)*o.currentScale+o.currentViewWidth*.5,(t.y-this.position.y)*o.currentScale+o.currentViewHeight*.5)}worldCoords(t){return new a((t.x-o.currentViewWidth*.5)/o.currentScale+this.position.x,(t.y-o.currentViewHeight*.5)/o.currentScale+this.position.y)}}const R=class R{constructor(){this.position=new a(0,0),this.previousPosition=new a(0,0),this.velocity=new a(0,0),this.acceleration=new a(0,0),this.damping=.9,this.captured=!1,this.id=0,this.id=R.nextID++}setPosition(t){this.position.setFrom(t),this.previousPosition.setFrom(t)}update(t){this.velocity.setFrom(a.sub(this.position,this.previousPosition).scale(this.damping).add(a.scale(this.acceleration,t*t))),this.acceleration.set(0,0),this.previousPosition.setFrom(this.position),this.position.add(this.velocity)}addForce(t){this.acceleration.add(t)}};R.nextID=0;let b=R;class rt{constructor(){this.camera=new st,this.lookAt=new a,this.cells=new Array,this.cellsToDivide=new Array,this.particles=new Array,this.particleRangeMax=0,this.collected=new Array}clear(){this.camera.reset(),this.lookAt.set(0,o.cameraOffset),this.cells=[],this.cellsToDivide=[],this.particles=[],this.particleRangeMax=2,this.collected=[]}generate(){this.clear(),b.nextID=0;let t=new E;t.setInitialValues(),t.updateValues(),this.cells.push(t),this.generateParticles()}generateParticles(){const t=-o.cameraOffset-this.camera.position.y+o.currentWorldHeight/2,i=-o.cameraOffset-this.camera.position.y-o.currentWorldHeight/2,s=Math.max(this.particleRangeMax,Math.floor(i/o.particleVerticalSpacing)),e=Math.max(this.particleRangeMax,Math.ceil(t/o.particleVerticalSpacing));this.particleRangeMax=e;for(let r=s;r<e;r++){const n=new b,l=new a((v.halton(r,2)-.5)*o.currentWorldWidth,-r*o.particleVerticalSpacing);n.setPosition(l),this.particles.push(n)}}ended(){return this.cells.length===0}click(t,i){let s=this.camera.worldCoords(new a(t,i)),e=this.getClosestAt(s);return!!(e!==null&&a.distance(s,e.position)<=e.radius&&this.divideCell(e))}getClosestAt(t){let i=Number.MAX_VALUE,s=null;for(let e of this.cells)if(!e.dead){let r=a.squaredDistance(e.position,t);(!i||r<i)&&(i=r,s=e)}return s}divideCell(t){if(!t.canDivide())return!1;for(let d=0;d<this.cells.length;d++)if(this.cells[d]===t){this.cells.splice(d,1);break}let i=v.lerp(u.minAngle,u.maxAngle,t.size),s=v.lerp(u.minRadius,u.maxRadius,t.size/2)+1,e=new a(-t.direction.y*s,t.direction.x*s),r=[],n=[];for(let d=0;d<t.captured.length;d++)d%2==0?r.push(t.captured[d]):n.push(t.captured[d]);let l=new E;l.size=t.size/2,l.position=t.position.copy().sub(e),l.direction=a.rotate(t.direction,v.rad(-i)),l.captured=r,this.cells.push(l);let c=new E;return c.size=t.size/2,c.position=t.position.copy().add(e),c.direction=a.rotate(t.direction,v.rad(i)),c.captured=n,this.cells.push(c),!0}collectParticles(){for(let t=0;t<this.cells.length;t++){let i=this.cells[t];for(let s=0;s<i.captured.length;s++)this.collected.push(i.captured[s]);i.captured=[]}}processCellsToDivide(){for(;this.cellsToDivide.length>0;)this.divideCell(this.cellsToDivide[0]),this.cellsToDivide.splice(0,1)}updateCellCollisions(){for(let e=0;e<this.cells.length;e++)for(let r=e+1;r<this.cells.length;r++){let n=this.cells[e],l=this.cells[r],c=a.squaredDistance(n.position,l.position),d=n.radius+l.radius;if(c<d*d){let f=a.sub(l.position,n.position);f.normalize();let g=d-Math.sqrt(c),y=1/n.radius,w=1/l.radius,z=y/(y+w),T=w/(y+w);n.position.sub(a.scale(f,g*z)),l.position.add(a.scale(f,g*T));let B=a.sub(l.direction,n.direction);a.dot(B,f)<0&&(n.direction.sub(a.scale(f,z)),n.direction.normalize(),l.direction.add(a.scale(f,T)),l.direction.normalize())}}const t=a.add(o.collectorPosition,this.camera.position);for(let e=0;e<this.cells.length;e++){let r=this.cells[e],n=a.squaredDistance(r.position,t),l=r.radius+o.collectorRadius;if(n<l*l){let c=a.sub(t,r.position);c.normalize();let d=l-Math.sqrt(n);r.position.sub(a.scale(c,d)),a.dot(r.direction,c)>0&&(r.direction.sub(c),r.direction.normalize())}}let i=-o.refWidth/2,s=o.refWidth/2;for(let e=0;e<this.cells.length;e++){let r=this.cells[e],n=!1;r.position.x-r.radius<i&&(r.position.x=i+r.radius,r.direction.x<0&&(n=!0)),r.position.x+r.radius>s&&(r.position.x=s-r.radius,r.direction.x>0&&(n=!0)),n&&(r.direction.x=-r.direction.x)}}updateCellInteractions(){for(let t=0;t<this.cells.length;t++)for(let i=0;i<this.cells.length;i++){if(t==i)continue;let s=this.cells[t],e=this.cells[i];if(s.dying()&&e.canDivide()){let r=a.distance(s.position,e.position);s.deadRadius+e.radius>r&&e.die()}else if(s.canChain()&&e.canDivide()){let r=a.distance(s.position,e.position);if(s.chainRadius+e.radius>r){let n=!1;for(let l=0;l<this.cellsToDivide.length;l++){let c=this.cellsToDivide[l];if(e===c){n=!0;break}}n||this.cellsToDivide.push(e)}}}}updateParticles(t){for(let s=0;s<this.particles.length;s++){let e=this.particles[s];if(!e.captured)for(let r=0;r<this.cells.length;r++){let n=this.cells[r];if(n.dying())continue;let l=a.sub(n.position,e.position),c=l.normalize();c<=n.radius?(e.captured=!0,n.captured.push(e)):c<u.particleAttractRadius&&e.addForce(a.scale(l,u.particleAttractForce))}}for(let s=0;s<this.cells.length;s++){let e=this.cells[s];if(!e.dying())for(let r=0;r<e.captured.length;r++){let n=e.captured[r],l=(v.halton(n.id,2)-.5)*2,c=l*Math.PI+o.currentTime*u.particleRotationRate*Math.sign(l),d=e.direction.perp().scale(e.radius*u.particleOrbitOffset*(r%2==0?-1:1)),f=new a(e.radius*u.particleOrbitScale,0).rotate(c).add(d),g=a.normalize(a.sub(a.add(e.position,f),n.position));n.addForce(a.scale(g,u.particleOrbitForce))}}const i=a.add(o.collectorPosition,this.camera.position);for(let s=0;s<this.collected.length;s++){let e=this.collected[s],r=a.sub(i,e.position);r.normalize()>o.collectorRadius&&e.addForce(a.scale(r,o.collectorForce))}for(let s=0;s<this.particles.length;s++)this.particles[s].update(t)}updateCamera(){if(this.cells.length===0)return;let t=0;for(let i=0;i<this.cells.length;i++){let s=this.cells[i];t=Math.min(t,s.position.y)}t+=o.cameraOffset,this.lookAt.y+=(t-this.lookAt.y)*o.cameraStiffness,this.camera.position.setFrom(this.lookAt)}update(t){let i=[];for(let s=0;s<this.cells.length;s++){let e=this.cells[s];e.update(t,!1),e.isDead()&&i.push(s)}for(let s=i.length-1;s>=0;s--)this.cells.splice(i[s],1);this.updateCellCollisions(),this.updateCellInteractions(),this.processCellsToDivide(),this.updateCamera(),this.updateParticles(t),this.generateParticles()}draw(t){t.programs.background.uniforms.u_camera_position.value.setFrom(this.camera.position),t.programs.background.uniforms.u_camera_scale.value.set(o.currentWorldWidth*.5,o.currentWorldHeight*.5),t.blendOff(),t.drawBuffer("screen","background"),t.blendPremul(),t.programs.cell.uniforms.u_resolution.value.set(o.currentViewWidth,o.currentViewHeight),t.programs.cell.uniforms.u_camera_position.value.setFrom(this.camera.position),t.programs.cell.uniforms.u_camera_scale.value.set(o.currentWorldWidth*.5,o.currentWorldHeight*.5);for(let s=0;s<this.cells.length;s++){let e=this.cells[s];t.programs.cell.uniforms.u_position.value.setFrom(e.position),t.programs.cell.uniforms.u_size.value.set(e.radius*2,e.radius*2),t.programs.cell.uniforms.u_direction.value.setFrom(e.direction),t.programs.cell.uniforms.u_split.value=v.clamp((e.timerDivide-u.divideDelay)/u.divideAnimDuration,0,1),t.programs.cell.uniforms.u_radius.value=u.maxRadius,e.blinkShow&&!e.dying()&&t.drawBuffer("quad","cell")}for(let s=0;s<this.cells.length;s++){let e=this.cells[s];t.programs.debug_circle.uniforms.u_camera_position.value.setFrom(this.camera.position),t.programs.debug_circle.uniforms.u_camera_scale.value.set(o.currentWorldWidth*.5,o.currentWorldHeight*.5),t.programs.debug_circle.uniforms.u_position.value.setFrom(e.position),e.canChain()&&(t.programs.debug_circle.uniforms.u_size.value.set(e.chainRadius*2,e.chainRadius*2),t.programs.debug_circle.uniforms.u_thickness.value=1,t.programs.debug_circle.uniforms.u_color.value.set(0,.5,0,1),t.drawBuffer("quad","debug_circle")),e.dying()&&(t.programs.debug_circle.uniforms.u_size.value.set(e.deadRadius*2,e.deadRadius*2),t.programs.debug_circle.uniforms.u_thickness.value=1,t.programs.debug_circle.uniforms.u_color.value.set(1,0,0,1),t.drawBuffer("quad","debug_circle"))}t.programs.collector.uniforms.u_camera_position.value.set(0,0),t.programs.collector.uniforms.u_camera_scale.value.set(o.currentWorldWidth*.5,o.currentWorldHeight*.5),t.programs.collector.uniforms.u_position.value.setFrom(o.collectorPosition),t.programs.collector.uniforms.u_size.value.set(o.collectorRadius*2,o.collectorRadius*2),t.programs.collector.uniforms.u_color.value.set(0,0,0,1),t.drawBuffer("quad","collector"),t.blendPremul(),t.programs.particle.uniforms.u_camera_position.value.setFrom(this.camera.position),t.programs.particle.uniforms.u_camera_scale.value.set(o.currentWorldWidth*.5,o.currentWorldHeight*.5);for(let s=0;s<this.particles.length;s++){let e=this.particles[s];e.captured&&(t.programs.particle.uniforms.u_position.value.setFrom(e.position),t.programs.particle.uniforms.u_size.value.set(60,60),t.programs.particle.uniforms.u_direction.value.setFrom(a.normalize(e.velocity)),t.programs.particle.uniforms.u_glow.value=1,t.programs.particle.uniforms.u_radius.value=4,t.programs.particle.uniforms.u_color.value.set(1,1,1,.99),t.drawBuffer("quad","particle"))}for(let s=0;s<this.particles.length;s++){let e=this.particles[s];t.programs.particle.uniforms.u_position.value.setFrom(e.position),t.programs.particle.uniforms.u_size.value.set(60,60),t.programs.particle.uniforms.u_direction.value.setFrom(a.normalize(e.velocity)),t.programs.particle.uniforms.u_glow.value=0,t.programs.particle.uniforms.u_radius.value=6,e.captured?t.programs.particle.uniforms.u_color.value.set(.5,.5,.5,.5):t.programs.particle.uniforms.u_color.value.set(0,0,0,.5),t.drawBuffer("quad","particle")}t.drawScreenText("debug",.1,0,"microbobs");const i=this.camera.cameraCoords(new a(o.collectorPosition.x,o.collectorPosition.y).add(this.camera.position));t.drawScreenText("debug",i.x,i.y,this.collected.length.toString())}}class W{}class A extends W{constructor(t,i){super(),this.x=t,this.y=i}}class k extends W{}class D{constructor(t){this.state=t}enter(){this.state.manager.switchTo(this.state)}}class at{constructor(){this.events=[],this.world=new rt,this.menu=new D(new ot(this)),this.game=new D(new nt(this)),this.end=new D(new lt(this))}switchTo(t){this.current&&this.current!==t&&this.current.onExit(),this.current=t,t.onEnter()}click(t,i){this.events.push(new A(t,i))}hide(){this.events.push(new k)}isRunning(t){return this.current===t}update(t){if(this.current){for(;this.events.length>0;){const i=this.events[0];this.current.handle(i),this.events.splice(0,1)}this.current.update(t)}}draw(t){this.current&&this.current.draw(t)}}class ot{constructor(t){this.manager=t}onEnter(){this.manager.world.generate()}onExit(){}handle(t){t instanceof A&&this.manager.world.click(t.x,t.y)&&this.manager.game.enter()}update(t){this.manager.world.updateCamera()}draw(t){this.manager.world.draw(t);const i=this.manager.world.camera.cameraCoords(new a(0,0));t.drawScreenText("debug",i.x-48,i.y-4.5*16,`tap to start
\0experiment
\0\0#7872304

\0\0>\0\0\0\0\0\0<`)}}class nt{constructor(t){this.paused=!1,this.manager=t}pauseText(){return this.paused?" ► unpause":" ■■ pause "}onEnter(){this.paused=!1}onExit(){}handle(t){if(t instanceof A&&!this.manager.world.click(t.x,t.y)){const i=this.manager.world.camera.worldCoords(new a(t.x,t.y)),s=a.add(o.collectorPosition,this.manager.world.camera.position);a.distance(i,s)<=o.collectorRadius&&this.manager.world.collectParticles();const r=this.pauseText();t.x>=o.currentViewWidth-r.length*8&&t.y<=16&&(this.paused=!this.paused)}t instanceof k&&(this.paused=!0)}update(t){this.paused||(this.manager.world.update(t),this.manager.world.ended()&&this.manager.end.enter())}draw(t){this.manager.world.draw(t);const i=this.pauseText();t.drawScreenText("debug",o.currentViewWidth-i.length*8,0,i),this.paused&&t.drawScreenText("debug",o.currentViewWidth/2-24,o.currentViewHeight/2,"PAUSED")}}class lt{constructor(t){this.endTimer=0,this.manager=t}onEnter(){this.endTimer=0}onExit(){}handle(t){t instanceof A&&this.endTimer>=o.endDelay&&this.manager.menu.enter()}update(t){this.endTimer+=t,this.manager.world.update(t)}draw(t){this.manager.world.draw(t),this.endTimer>=o.endDelay&&t.drawScreenText("debug",o.currentViewWidth/2-56,o.currentViewHeight/2,"tap to restart")}}{let m=function(c){for(requestAnimationFrame(m),l+=(c-r)/1e3,r=c;l>=n;)o.currentTime+=n,e.update(n),l-=n;i.viewport(0,0,t.width,t.height),i.clear(i.COLOR_BUFFER_BIT),e.draw(s)};const t=document.createElement("canvas");document.body.appendChild(t);const i=t.getContext("webgl2");i.clearColor(1,1,0,1);{let c=function(){let d=[window.innerWidth,window.innerHeight];o.resize(d[0],d[1]);const f=o.currentViewWidth,g=o.currentViewHeight;t.style.left=d[0]/2-f/2+"px",t.style.top=d[1]/2-g/2+"px",t.style.width=f+"px",t.style.height=g+"px",t.width=f,t.height=g};window.addEventListener("resize",c,!1),c()}const s=new it(i),e=new at;e.menu.enter(),window.addEventListener("pointerdown",c=>{e.click(c.offsetX,c.offsetY),c.preventDefault()}),window.addEventListener("touchstart",c=>c.preventDefault(),{passive:!1}),window.addEventListener("visibilitychange",()=>{document.hidden&&e.hide()});let r=performance.now();const n=1/30;let l=0;requestAnimationFrame(m)}
